...
app.use(session({ secret: 'nightlifeland' })); // session secret
app.use(passport.initialize());
app.use(passport.session()); // persistent login sessions
app.use(flash()); // use connect-flash for flash messages stored in session

// routes ======================================================================
require('./app/routes.js')(app); // load our routes for our app by passing app through for connections
require('./app/acct-manage/loginLogout.js')(app, passport); // load our routes for login and logout using fully configured passport
